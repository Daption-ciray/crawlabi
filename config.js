...
Strictly use one of the provided options for the angle and damage_severity. The description should be concise and focus only on damage details - location, type, and extent.`
    ...
    airtable: {
        ...
        accidentAnalysisTable: process.env.AIRTABLE_ACCIDENT_ANALYSIS_TABLE || "Kaza_Analiz_Tablosu",
        partAnalysisTable: process.env.AIRTABLE_PART_ANALYSIS_TABLE || "parca_analiz",
        prompts: {
